...
import { printSmartAsset, defaults as smartAssetdefaults, SmartAssetOptions } from './smart-asset';
...
export type SmartAsset = WizardContractAPI<SmartAssetOptions>;
...
export const smartAsset: SmartAsset = {
  print: printSmartAsset,
  defaults: smartAssetdefaults,
